    ...
    def on_event(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_z:
                self.emulator.set_key_system(0, 1)
            if event.key == pygame.K_x:
                self.emulator.set_key_system(1, 1)
            if event.key == pygame.K_c:
                self.emulator.set_key_system(2, 1)
            if event.key == pygame.K_v:
                self.emulator.set_key_system(3, 1)
        ...
        if event.type == pygame.KEYUP:
            ...
            if event.key == pygame.K_z:
                self.emulator.set_key_system(0, 0)
            if event.key == pygame.K_x:
                self.emulator.set_key_system(1, 0)
            if event.key == pygame.K_c:
                self.emulator.set_key_system(2, 0)
            if event.key == pygame.K_v:
                self.emulator.set_key_system(3, 0)
